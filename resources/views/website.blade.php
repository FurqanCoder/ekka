...
<head>
    ...
    <!-- site Favicon -->
    <link rel="icon" href="web/images/favicon/favicon.png" sizes="32x32" />
    <link rel="apple-touch-icon" href="web/images/favicon/favicon.png" />
    <meta name="msapplication-TileImage" content="web/images/favicon/favicon.png" />

    <!-- css Icon Font -->
    <link rel="stylesheet" href="web/css/vendor/ecicons.min.css" />

    <!-- css All Plugins Files -->
    <link rel="stylesheet" href="web/css/plugins/animate.css" />
    <link rel="stylesheet" href="web/css/plugins/swiper-bundle.min.css" />
    <link rel="stylesheet" href="web/css/plugins/jquery-ui.min.css" />
    <link rel="stylesheet" href="web/css/plugins/countdownTimer.css" />
    <link rel="stylesheet" href="web/css/plugins/slick.min.css" />
    <link rel="stylesheet" href="web/css/plugins/bootstrap.css" />

    <!-- Main Style -->
    <link rel="stylesheet" href="web/css/demo1.css" />
    <link rel="stylesheet" href="web/css/style.css" />
    <link rel="stylesheet" href="web/css/responsive.css" />

    <!-- Background css -->
    <link rel="stylesheet" id="bg-switcher-css" href="web/css/backgrounds/bg-4.css">
</head>
...
<body>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.html"><img src="web/images/logo/logo.png" alt="Site Logo" /><img
                                        class="dark-logo" src="web/images/logo/dark-logo.png" alt="Site Logo"
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                            class="img-responsive" src="web/images/menu-banner/1.jpg"
                                                            alt=""></a></li>
                                                <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                            class="img-responsive" src="web/images/menu-banner/2.jpg"
                                                            alt=""></a></li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                            class="img-responsive" src="web/images/menu-banner/3.jpg"
                                                            alt=""></a></li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                            class="img-responsive" src="web/images/menu-banner/4.jpg"
                                                            alt=""></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <li><a href="javascript:void(0)">Categories</a>
                            <ul class="sub-menu">
                                ...
                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                            src="web/images/menu-banner/1.jpg" alt=""></a>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="web/images/product-image/6_1.jpg" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                src="web/images/product-image/12_1.jpg" alt="product"></a>
                        <div class="ec-pro-content">
                ...
                <div class="ec-sidebar-wrap">
                    ...
                    <div class="ec-sidebar-block">
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/dress-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/shoes-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/jewelry-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/perfume-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/cosmetics-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/glasses-8.png"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item"><img src="web/images/icons/bag-8.png"
                ...
                <div class="ec-sb-pro-sl">
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/1.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/2.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/3.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/4.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/5.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/6.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                                    src="web/images/product-image/7.jpg" alt="product" /></a>
                            <div class="ec-pro-content">
                ...
                <div class="col-lg-3">
                    <ul class="ec-cat-tab-nav nav">
                        <li class="cat-item"><a class="cat-link active" data-bs-toggle="tab" href="#tab-cat-1">
                                <div class="cat-icons"><img class="cat-icon" src="web/images/icons/cat_1.png"
                                        alt="cat-icon"><img class="cat-icon-hover" src="web/images/icons/cat_1_1.png"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-2">
                                <div class="cat-icons"><img class="cat-icon" src="web/images/icons/cat_2.png"
                                        alt="cat-icon"><img class="cat-icon-hover" src="web/images/icons/cat_2_1.png"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-3">
                                <div class="cat-icons"><img class="cat-icon" src="web/images/icons/cat_3.png"
                                        alt="cat-icon"><img class="cat-icon-hover" src="web/images/icons/cat_3_1.png"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-4">
                                <div class="cat-icons"><img class="cat-icon" src="web/images/icons/cat_4.png"
                                        alt="cat-icon"><img class="cat-icon-hover" src="web/images/icons/cat_4_1.png"
                                        alt="cat-icon"></div>
                ...
                <div class="col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-cat-1">
                            <div class="row">
                                <img src="web/images/cat-banner/1.jpg" alt="" />
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-cat-2">
                            <div class="row">
                                <img src="web/images/cat-banner/2.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-3">
                            <div class="row">
                                <img src="web/images/cat-banner/3.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-4">
                            <div class="row">
                                <img src="web/images/cat-banner/4.jpg" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
            ...
            <div class="row margin-minus-t-15 margin-minus-b-15">
                    ...
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="web/images/vendor/2.jpg" alt="vendor img">
                            </div>
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/1_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/2_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/3_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/4_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="web/images/vendor/3.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/5_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/6_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/7_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/8_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="web/images/vendor/4.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/9_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/10_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/11_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/12_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="web/images/vendor/5.jpg" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/13_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/14_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/15_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="web/images/product-image/16_1.jpg"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="web/images/product-image/9_1.jpg" alt="Product" />
                                    <img class="hover-image" src="web/images/product-image/9_2.jpg" alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="sale">Sale</span>
                                </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="web/images/product-image/11_1.jpg" alt="Product" />
                                    <img class="hover-image" src="web/images/product-image/11_2.jpg" alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="new">New</span>
                                </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="web/images/product-image/12_1.jpg" alt="Product" />
                                    <img class="hover-image" src="web/images/product-image/12_2.jpg" alt="Product" />
                                </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="web/images/product-image/13_1.jpg" alt="Product" />
                                    <img class="hover-image" src="web/images/product-image/13_2.jpg" alt="Product" />
                                </a>
                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                        class="fi-rr-eye"></i></a>
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="web/images/testimonial/1.jpg" /></div>
                        ...
                        <li class="ec-test-item ">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="web/images/testimonial/2.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                        ...
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="web/images/testimonial/3.jpg" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                    ...
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/1.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/2.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/3.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/4.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/5.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/6.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="web/images/instragram-image/7.jpg"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img src="web/images/logo/footer-logo.png"
                                            alt=""><img class="dark-footer-logo" src="web/images/logo/dark-logo.png"
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="web/images/product-image/3_1.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="web/images/product-image/3_2.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="web/images/product-image/3_3.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="web/images/product-image/3_4.jpg" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="web/images/product-image/3_5.jpg" alt="">
                                </div>
                            </div>
    ...
    <div id="ec-popnews-box">
        ...
        <div class="row">
            <div class="col-md-6 disp-no-767">
                <img src="web/images/banner/newsletter.png" alt="newsletter">
            </div>
            <div class="col-md-6">
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
            ...
            <span class="ec-cart-count cart-count-lable">6</span>
        </a>
    </div>
                        ...
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="ec-img-cont">
                                    <img src="web/images/whatsapp/profile_01.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="web/images/whatsapp/profile_02.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="web/images/whatsapp/profile_03.jpg" class="ec-user-img"
                                        alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266"
                            ...
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="web/images/whatsapp/profile_04.jpg" class="ec-user-img"
                                        alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
    ...
    <div class="ec-tools-sidebar">
        ...
        <a href="#" class="ec-tools-sidebar-toggle in-out">
            <img alt="icon" src="web/images/common/settings.png">
        </a>
    ...
    <!-- Vendor JS -->
    <script src="web/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="web/js/vendor/popper.min.js"></script>
    <script src="web/js/vendor/bootstrap.min.js"></script>
    <script src="web/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="web/js/vendor/modernizr-3.11.2.min.js"></script>

    <!--Plugins JS-->
    <script src="web/js/plugins/swiper-bundle.min.js"></script>
    <script src="web/js/plugins/countdownTimer.min.js"></script>
    <script src="web/js/plugins/scrollup.js"></script>
    <script src="web/js/plugins/jquery.zoom.min.js"></script>
    <script src="web/js/plugins/slick.min.js"></script>
    <script src="web/js/plugins/infiniteslidev2.js"></script>
    <script src="web/js/vendor/jquery.magnific-popup.min.js"></script>
    <script src="web/js/plugins/jquery.sticky-sidebar.js"></script>

    <!-- Main Js -->
    <script src="web/js/vendor/index.js"></script>
