                          ...
                          <div class="header-search">
                              <form class="ec-btn-group-form" action="{{ route('web.filter') }}" method="GET">
                                  <input class="form-control ec-search-bar" name="search"
                                      placeholder="Search products..." type="text" value="{{ request('search') }}">
                      ...
                      <div class="ec-main-menu">
                          ...
                          <ul>
                              ...
                              <li class="dropdown position-static">
                                  ...
                                  <ul class="mega-menu d-block">
                                      ...
                                      <!-- Example: Replace with Backend Loop -->
                                      {{-- @foreach ($categories as $category)
                                    <ul class="d-block">
                                        <li class="menu_title"><a href="#">{{ $category->name }}</a></li>
                              ...
                              {{-- <li>
                                    <ul class="ec-main-banner w-100">
                                        <li><a class="p-0" href="#"><img class="img-responsive" src="{{ asset('web/images/menu-banner/1.jpg') }}" alt=""></a></li>
                                        <li><a class="p-0" href="#"><img class="img-responsive" src="{{ asset('web/images/menu-banner/2.jpg') }}" alt=""></a></li>
                                    </ul>
                                </li> --}}
                          </ul>
                          </li>
                          ...
                          <li class="dropdown">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="{{ url('best-selling') }}">Best Selling</a></li>
                                  <li><a href="{{ url('featured-products') }}">Featured</a></li>
                              </ul>
                          </li>
                          ...
                          <li class="dropdown">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  <li><a href="{{ url('blog/latest') }}">Latest Posts</a></li>
                              </ul>
                          </li>


                          <!-- Hot Offers -->
                          <li><a href="{{ url('offers') }}">Hot Offers</a></li>
