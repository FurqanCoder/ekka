                                            ...
                                            <div class="card-body">
                                                ...
                                                <div>
                                                    <form wire:submit.prevent="login">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input primary" type="checkbox"
                                                                    id="flexCheckChecked" wire:model="remember">
                                                        ...
                                                        {{-- Submit Button --}}
                                                        <button type="submit"
                                                            class="btn btn-dark w-100 py-2 mb-4 rounded-1">Sign
                                                            In</button>

                                                        <div class="d-flex align-items-center">
                                                            <p class="fs-12 mb-0 fw-medium">Don’t have an account yet?
                                                            </p>
                                                            <a class="text-primary fw-bolder ms-2"
                                                                href="{{ route('dev-register') }}">Sign Up Now</a>
                                                        </div>
                                                    </form>
                                                </div>
