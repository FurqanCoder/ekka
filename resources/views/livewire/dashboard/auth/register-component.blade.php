                        ...
                        <div class="row">
                          <div class="col-6 mb-2 mb-sm-0">
                            <a class="btn btn-white shadow-sm text-dark link-primary border fw-semibold d-flex align-items-center justify-content-center rounded-1 py-6"
                              ...
                              <img src="../assets/images/svgs/facebook-icon.svg" alt="matdash-img"
                          ...
                          <div class="col-6">
                            <a class="btn btn-white shadow-sm text-dark link-primary border fw-semibold d-flex align-items-center justify-content-center rounded-1 py-6"
                              href="javascript:void(0)" role="button">
                              <img src="../assets/images/svgs/google-icon.svg" alt="matdash-img" class="img-fluid me-2"
                                width="18" height="18">
    ...
    <form wire:submit.prevent="register">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror"
                   wire:model.defer="name" id="text-name" placeholder="Enter your name">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror"
                   wire:model.defer="email" id="exampleInputEmail1" placeholder="Enter your email">
            @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="password" class="form-control @error('password') is-invalid @enderror"
                   wire:model.defer="password" id="exampleInputPassword1" placeholder="Enter your password">
            @error('password')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="form-check">
                <input class="form-check-input primary" type="checkbox" wire:model="remember"
                       id="flexCheckChecked">
        ...
        {{-- Submit Button --}}
        <button type="submit" class="btn btn-dark w-100 py-2 mb-4 rounded-1">
            Sign Up
        </button>

        <div class="d-flex align-items-center">
            <p class="fs-12 mb-0 fw-medium">Already have an Account?</p>
            <a class="text-primary fw-bolder ms-2" href="{{ route('dev-login') }}">Sign in Now</a>
        </div>
    </form>
</div>
