                            ...
                            <div class="row gx-0">
                                        ...
                                        <div class="col-lg-11">
                                            <div class="card-body">
                                                <a href="index.html" class="text-nowrap logo-img d-block mb-4 w-100">
                                                    <img src="../assets/images/logos/logo.svg" class="dark-logo"
                                                        alt="Logo-Dark">
                                                </a>
                                                    ...
                                                    <form wire:submit.prevent="register">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                wire:model.defer="name" id="text-name"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email"
                                                                ...
                                                                wire:model.defer="email" id="exampleInputEmail1"
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="password"
                                                                ...
                                                                wire:model.defer="password" id="exampleInputPassword1"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input primary" type="checkbox"
                                                                    wire:model="remember" id="flexCheckChecked">
                                                        ...
                                                        {{-- Submit Button --}}
                                                        <button type="submit"
                                                            class="btn btn-dark w-100 py-2 mb-4 rounded-1">
                                                            Sign Up
                                                        </button>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a class="text-primary fw-bolder ms-2"
                                                                href="{{ route('dev-login') }}">Sign in Now</a>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <div class="col-xl-6 d-none d-xl-block">
                                    <div class="row justify-content-center align-items-center h-100">
                                        <div class="col-lg-9">
                                            <div id="auth-login" class="carousel slide auth-carousel"
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <div
                                                            ...
                                                            <img src="../assets/images/backgrounds/login-side.png"
